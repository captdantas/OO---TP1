...
public class ModuloProduto {
	...
	public void bancoDeProdutos() {
		...
		produto7.setDescricao("por Clarissa Pinkola Est�s");
		...
		produto8.setProduto("O andar do b�bado: Como o acaso determina nossas vidas");
		...
		produto9.setProduto("O homem mais rico da Babil�nia");
	...
	public boolean venderProduto(int index, int quantidade) {
		...
		if (produto.estoque < quantidade) {
			System.out.println("Quantidade do produto indisponível. Só é possível vender: " + produto.estoque + " unidades.");
			return false;
		}
